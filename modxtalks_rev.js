...
jQuery.MTAjax = function (options) {
    ...
    var handlerSuccess = function (result, textStatus, XMLHttpRequestObject) {
        ...
        if (typeof result.redirect != "undefined") {
            jQuery(window).unbind("http://visage-school.ru/assets/components/modxtalks/js/web/beforeunload.ajax");
...
jQuery(function () {
    ...
    jQuery(document).bind("ajaxStart", function () {
        ...
        jQuery(window).bind("http://visage-school.ru/assets/components/modxtalks/js/web/beforeunload.ajax", function () {
        ...
        if (preview) {
            ...
            jQuery.MTAjax({
                ...
                success: function (data) {
                    ...
                    // setTimeout(function () { jQuery('http://visage-school.ru/assets/components/modxtalks/js/web/a.time').timeago() }, 5000);
                }
            });
        }
